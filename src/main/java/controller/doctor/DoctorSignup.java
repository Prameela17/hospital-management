...
public class DoctorSignup extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (dao.fetchDoctor(mobile) == null && dao.fetchDoctor(email) == null && dao.fetchStaff(mobile) == null
				&& dao.fetchStaff(email) == null) {
			...
			resp.getWriter().print("<h1 style='color:yellow'>Your Doctor Id is : " + doctor.getId() + "</h1>");
